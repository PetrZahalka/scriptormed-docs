---
title: Desktop — Přehled
description: ScriptorMed Desktop — desktopová aplikace pro nahrávání konzultací a generování klinických zpráv
---
...
1. [Nainstalujte aplikaci](instalace.md) na váš počítač
2. [Zadejte licenční klíč](prvni-spusteni.md) a ověřte připojení
3. [Nahrajte první konzultaci](nahravani.md)
4. [Prohlédněte a upravte zprávu](klinicka-zprava.md)

!!! tip "Potřebujete pomoc?"
    Pokud narazíte na problém, podívejte se do sekce [Řešení problémů](../faq.md) nebo [kontaktujte podporu](../kontakt.md).
