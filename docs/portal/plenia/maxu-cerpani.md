...
Na obrazovce **Purobot** vidíte, kolik z maximální úhrady už máte vykázáno:
...
1. **Mimořádně nákladní pojištěnci** – pacienti blízko prahu (kandidáti). Doplněním indikované péče překročí práh a celá jejich péče se pak hradí mimo strop. Viz [Pojištěnci a mimořádně nákladní](pojistenci-mnp.md).
...
Obrazovka **Výkony** ukáže přehled vykázaných výkonů – počet, body, úhradu, počet unikátních pojištěnců a podíl na celku. Výkony hrazené mimo strop jsou označené.
