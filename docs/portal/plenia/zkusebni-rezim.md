...
description: Ukázková data, rozsah nahrávání během zkušebního období a přechod na vlastní data a předplatné.
---

# Zkušební režim

Plenia si můžete vyzkoušet zdarma – nejdřív na **ukázkových (anonymizovaných) datech** a pak i na vlastních dávkách. Modul lze registrovat samostatně, bez klinické části ScriptorMed; funguje jen ve webovém prohlížeči a kvůli rodným číslům vyžaduje **dvoufaktorové ověření**.
...
## Rozsah nahrávání ve zkušebním období { #limit }

Ve zkušebním režimu můžete nahrávat vlastní K-dávky v tomto rozsahu:

| Data | Zkušební režim |
|------|----------------|
| Pojišťovna | jen **VZP** |
| Aktuální rok | období **leden–květen** (červen–prosinec po aktivaci předplatného) |
| Historické roky | **bez omezení** |
| Faktury (zálohy) a PDF dokumenty | **bez omezení** |

Dávka mimo tento rozsah se při nahrání přeskočí s vysvětlující hláškou. Po aktivaci předplatného je nahrávání neomezené.
...
- První kroky po registraci: [Rychlý průvodce](rychly-pruvodce.md)
